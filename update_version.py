...
def main():
  ...
  CFBundleGetInfoString = FullVersionStr + ", Copyright Specdrum, " + str(today.year)
  CFBundleVersion = FullVersionStr
  
  print "update_version.py - setting version to " + FullVersionStr
  print "Updating plist version info..."
  
  plistpath = scriptpath + "/resources/Genesis-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Genesis-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Genesis-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Genesis-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Genesis-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Genesis-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/Genesis-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/Genesis.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/Genesis.iss",inplace=1):
